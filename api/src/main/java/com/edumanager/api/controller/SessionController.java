...
public class SessionController {
    ...
    @RequestMapping(value = "/{sessionId}/announcement", method = {RequestMethod.PATCH, RequestMethod.PUT, RequestMethod.POST})
    ...
    @RequestMapping(value = "/api/sessions/{sessionId}/announcement", method = {RequestMethod.PATCH, RequestMethod.PUT, RequestMethod.POST})
    public SessionResponseDTO updateAnnouncementDirect(
            @PathVariable Long sessionId,
            @RequestBody java.util.Map<String, String> payload,
            jakarta.servlet.http.HttpServletRequest request) {
        Long callerId = (Long) request.getAttribute("userId");
